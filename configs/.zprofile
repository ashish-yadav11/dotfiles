...
#export FZF_DEFAULT_OPTS="--cycle --layout=reverse --no-unicode --bind='change:first,alt-,:first,alt-.:last,ctrl-d:delete-char,ctrl-g:first,ctrl-q:clear-selection,ctrl-v:select-all,ctrl-z:deselect-all,ctrl-s:toggle,ctrl-t:toggle-all,ctrl-space:toggle-sort,ctrl-y:execute-silent(echo -n {} | xsel -ib)'"
