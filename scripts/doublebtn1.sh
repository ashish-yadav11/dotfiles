#!/bin/dash
lck7file="$XDG_RUNTIME_DIR/doublebtn1.1.lck"
lck8file="$XDG_RUNTIME_DIR/doublebtn1.2.lck"
lck9file="$XDG_RUNTIME_DIR/doublebtn1.3.lck"
...
errorexit() {
    notify-send -u critical -t 0 dwm 'doublebtn1: something went wrong!'
    exit
